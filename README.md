...
|--------|-------------|------------|
| [**Baby Mine App**](https://github.com/thimathi/baby_mine) | A smart baby care mobile application integrating real-time monitoring, Supabase, and IoT sensor. | `React Native`, `Supabase`, `NodeMCU`, `IoT` |
